...
```{r model_sm, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}

# Build a model
model_sm <- C5.0(as.factor(test.obesity_leveloverweight) ~ .,
                 data = train_sm)
```
...
```{r model_sm_cost, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
# Build a model
